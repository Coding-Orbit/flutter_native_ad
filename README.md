...
A Flutter project to implement admob native ad in your flutter app.
...
If you are applying this video to your app and you're not cloning the project, you can find the files used to implement native ad under the assets folder in this repo.